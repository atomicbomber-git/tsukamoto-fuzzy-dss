        ...
        [
            ...
            "parameters" => [
                "Muda" => [
                    ...
                    ["syarat" => "(25 <= x) && (x <= 40)", "formula" => "(40 - x) / (40 - 25)",],
                    ["syarat" => "x > 40", "formula" => "0"]
                ],
                "Parobaya" => [
                    ["syarat" => "x <= 35", "formula" => "0"],
                    ["syarat" => "(35 < x) && (x <= 40)", "formula" => "(x - 35) / (40 - 35)",],
                    ["syarat" => "(40 < x) && (x <= 60)", "formula" => "(60 - x) / (60 - 40)",],
                    ["syarat" => "x > 160", "formula" => "0"],
                ],
                "Tua" => [
                    ["syarat" => "x <= 55", "formula" => "0"],
                    ["syarat" => "(55 < x) && (x <= 60)", "formula" => "(x - 55) / (60 - 55)",],
                    ["syarat" => "(60 < x) && (x <= 70)", "formula" => "(70 - x) / (70 - 60)",],
                    ["syarat" => "x > 70", "formula" => "0"],
                ],
                "Sangat Tua" => [
                    ["syarat" => "x < 65", "formula" => "0",],
                    ["syarat" => "(65 <= x) && (x <= 70)", "formula" => "(x - 65) / (70 - 65)",],
        ...
        [
            ...
            "parameters" => [
                "Sangat Kurus" => [
                    ...
                    ["syarat" => "(16.5 < x) && (x < 17.5)", "formula" => "(x - 16.5) / (17 - 16.5)",],
                    ["syarat" => "x >= 17", "formula" => "0"]
                ],
                "Kurus" => [
                    ["syarat" => "x <= 16.5", "formula" => "0"],
                    ["syarat" => "(16.5 < x) && (x <= 17)", "formula" => "(x - 16.5) / (17 - 16.5)",],
                    ["syarat" => "(17 < x) && (x <= 18)", "formula" => "1",],
                    ["syarat" => "(18 < x) && (x <= 18.5)", "formula" => "(18.5 - x) / (18.5 - 18)"],
                    ["syarat" => "x > 18.5", "formula" => "0"],
                ],
                "Normal" => [
                    ["syarat" => "x <= 18", "formula" => "0"],
                    ["syarat" => "(18 < x) && (x <= 17)", "formula" => "(x - 18) / (18.5 - 18)",],
                    ["syarat" => "(18.5 < x) && (x <= 24.5)", "formula" => "1",],
                    ["syarat" => "(24.5 < x) && (x <= 25)", "formula" => "(25 - x) / (25 - 24.5)"],
                    ["syarat" => "x > 25", "formula" => "0"],
                ],
                "Gemuk" => [
                    ["syarat" => "x <= 24.5", "formula" => "0"],
                    ["syarat" => "(24.5 < x) && (x <= 25)", "formula" => "(x - 24.5) / (25 - 24.5)",],
                    ["syarat" => "(25 < x) && (x <= 26.5)", "formula" => "1",],
                    ["syarat" => "(26.5 < x) && (x <= 27)", "formula" => "(26.5 - x) / (27 - 26.5)"],
                    ["syarat" => "x > 27", "formula" => "0"],
                ],
                "Sangat Gemuk" => [
                    ["syarat" => "x <= 26.5", "formula" => "0",],
                    ["syarat" => "(26.5 < x) && (x < 27)", "formula" => "(x - 26.5) / (27 - 26.5)",],
        ...
        [
            ...
            "parameters" => [
                "Istirahat" => [
                    ...
                    ["syarat" => "(2 < x) && (x < 4)", "formula" => "(4 - x) / (4 - 2)",],
                    ["syarat" => "x >= 4", "formula" => "0"]
                ],
                "Ringan" => [
                    ["syarat" => "x <= 3", "formula" => "0"],
                    ["syarat" => "(3 < x) && (x <= 4)", "formula" => "(x - 3) / (4 - 3)",],
                    ["syarat" => "(4 < x) && (x <= 5)", "formula" => "(5 - x) / (5 - 4)"],
                ...
                "Berat" => [
                    ...
                    ["syarat" => "(7 < x) && (x <= 8)", "formula" => "(x - 7) / (8 - 7)",],
                    ["syarat" => "(8 < x) && (x <= 9)", "formula" => "(9 - x) / (9 - 8)"],
                    ["syarat" => "x > 9", "formula" => "0"],
                ],
                "Sangat Berat" => [
                    ["syarat" => "x <= 8", "formula" => "0",],
                    ["syarat" => "(8 < x) && (x < 10)", "formula" => "(x - 8) / (10 - 8)",],
        ...
        [
            ...
            "parameters" => [
                "Sedikit" => [
                    ...
                    ["syarat" => "(1300 <= x) && (x <= 2500)", "formula" => "(2500 - x) / (2500 - 1300)"],
                    ["syarat" => "x > 2500", "formula" => "0"],
                ],

                "Banyak" => [
                    ["syarat" => "x < 1300", "formula" => "0"],
                    ["syarat" => "(1300 <= x) && (x <= 2500)", "formula" => "(x - 1300) / (2500 - 1300)"],
