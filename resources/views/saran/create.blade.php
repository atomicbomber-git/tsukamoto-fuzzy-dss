...
@section('content')
    ...
    <h1 class="text-2xl font-bold mb-5"> Tambah Saran </h1>

    <div class="w-full">
        <form method="POST" action="{{ route('saran.store') }}" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            @csrf
            <div class="mb-2">
            ...
            <div class="mb-2">
                ...
                <textarea
                    ...
                    id="content" type="konten" placeholder="Konten">{{ old("konten")}}</textarea>
