...
@section('body-main')
    ...
    <div class="md:flex md:w-3/4 md:mx-auto">
        <div id="sidebar" class="border-b pb-3 pl-3 hidden md:block md:pb-0 md:border-b-0 md:w-3/12 lg:w-2/12 pt-5">
            @include('shared.sidebar-admin')
        </div>

        <div class="border h-full md:w-9/12 lg:w-10/12  p-5 mb-10">
            <div class="px-3">
                @yield('content')
            </div>
        </div>
